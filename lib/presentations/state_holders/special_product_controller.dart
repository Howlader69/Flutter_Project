import 'package:ecomerce_project/data/models/network_response.dart';
import 'package:ecomerce_project/data/models/product_model.dart';
import 'package:ecomerce_project/data/services/network_caller.dart';
...
class SpecialProductController extends GetxController{
 ...
 Future<bool> getSpecialProducts()async{
  ...
  if(response.isSuccess){
   ...
   _errorMessage='Special fetch failed! try again';
   update();
   return false;
  }
 }
